                            ...
                            <div class="col-lg-12">
                                <div class="card mb-4">
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                        <h6 class="m-0 font-weight-bold text-primary">Residentes</h6>
                                    </div>
                                    <div style="text-align:right;margin-right:20px">
                                        <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#newModal">
                                            <i class="fas fa-plus"> Nuevo Residente</i>
                                        </button>
                                    </div>
                                    <div class="table-responsive p-3">
                                        <table class="table align-items-center table-flush" id="residents">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Nombre</th>
