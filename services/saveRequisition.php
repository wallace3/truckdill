<?php
    ...
    array_push($proyecto,array('Project'=>$_POST['proyecto'],'Equipment'=>$_POST['equipo'],'Number'=>$_POST['economico'],'Emition_Date'=>$_POST['fecha_emision'],'Required_Date'=>$_POST['fecha_requerida'],'Folio'=>$_POST['folio'], 'Depto'=>$_POST['depto'],'Observations'=>$_POST['observaciones'],'Justification'=>$_POST['justificacion'],'Employee'=>$_POST['solicitante'],'ID_Resident'=>$idResident,'ID_Drill'=>$drill,'Status'=>1,'Date'=>$current ));
