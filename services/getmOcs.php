...
$columns = array(
    ...
    array( 'db' => '`x`.`Equipment`',  'dt' => 2, 'field' => 'Equipment' ),
    array( 'db' => '`x`.`Folio`',  'dt' => 3, 'field' => 'Folio' ),
    array( 'db' => '`x`.`Depto`',  'dt' => 4, 'field' => 'Depto' ),
    array( 'db' => '`x`.`Total`',  'dt' => 5, 'field' => 'Total' ),
